...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions/partitions_esp32.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions/partitions_esp32.csv"
...
#define CONFIG_TLS_STACK_WOLFSSL 1
